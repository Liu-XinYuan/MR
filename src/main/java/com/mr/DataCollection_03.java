...
public class DataCollection_03 {
	private static final Logger log = Logger.getLogger(DataCollection_03.class
			.getName());
	...
	public static void main(String[] args) throws IOException,
		...
		Job job = new Job(conf, "dc_real_03");
		job.setJarByClass(DataCollection_03.class);
